          ...
          <div className="w-full justify-center   ">
            ...
            <div className="flex w-full justify-center ">
              <form onSubmit={handleSubmit}>
                <div className="search-bg mb-4 h-[54.37px] items-center justify-between rounded-lg border border-[#FFFFFF1A] bg-[#282828] px-3 py-4 hover:border-[#1B5EED4D] focus:border-[#1B5EED4D] focus:bg-[#FBFAFC] max-sm:mb-2 max-sm:w-[320px] xl:w-[536px]">
                  <div className="flex">
                    <input
                      type="password"
                      name="password1"
