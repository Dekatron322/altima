          ...
          <div className="w-full justify-center   ">
            ...
            <div className="flex w-full justify-center ">
              <form onSubmit={handleSubmit}>
                <div className="search-bg mb-2 h-[54.37px]  items-center justify-between rounded-lg border border-[#FFFFFF1A] bg-[#282828] px-3 py-4 hover:border-[#1B5EED4D] focus:border-[#1B5EED4D] focus:bg-[#FBFAFC] max-xl:mb-3 max-xl:w-[430px] max-sm:w-[320px] xl:w-[536px]">
                  <div className="flex">
                    <input
                      type="password"
                      name="password1"
                ...
                <div className="mt-5 flex w-full justify-center gap-6 md:px-6">
                  <button
                    type="submit"
                    className="font-regular flex w-[60%] items-center justify-center gap-2  rounded-lg border  bg-[#FFFFFF26] px-4 py-4 uppercase text-[#FFFFFF] max-sm:w-full "
                  >
