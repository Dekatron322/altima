        ...
        <div className="  w-full justify-between md:py-10">
          ...
          <div className="flex w-full justify-between max-xl:grid max-sm:grid max-sm:gap-5  md:gap-20">
            ...
            <div className="">
              ...
              <p className=" my-6 text-base  font-bold   leading-none tracking-tight text-[FFFFFFCC]  max-xl:hidden md:text-xl xl:text-3xl">
                ALTIMA Core
              </p>
              <div>
                <div className="items-center justify-between bg-[#151515] px-4 py-2 text-black max-xl:w-full max-xl:justify-center xl:flex xl:max-w-[522px]">
                  <ul className="list-inside ">
                    <li className="py-2 text-[#FFFFFFCC]  max-sm:text-sm">Advanced Home Control </li>
                    <li className=" text-[#FFFFFFCC]  max-sm:text-sm">All Pro features, plus:</li>
                  </ul>
            ...
            <div className="max-xl:flex max-xl:w-full max-xl:flex-col max-xl:items-center max-xl:justify-center  ">
              ...
              <div>
                <div className="flex items-center justify-between gap-6 bg-[#000000] px-4 py-2 text-black max-xl:hidden xl:max-w-[522px]">
                  <ul className="list-inside ">
                    <li className=" text-[#FFFFFFCC] max-sm:text-sm">Ultimate Smart Home Hub </li>
                    <li className=" text-[#FFFFFFCC] max-sm:text-sm">All Pro features, plus</li>
                  </ul>
              ...
              <div className="flex items-center justify-between bg-[#FFFFFF0D] px-7 py-3 max-xl:hidden">
                <ul className=" list-inside  pl-2">
                  <li className=" text-[#FFFFFFCC] opacity-80 max-sm:text-sm">Feature Comparison</li>
                </ul>
                <div>
                  <ul className=" flex list-inside items-center gap-2 pl-2">
                    <li className=" text-[#FFFFFFCC] underline opacity-80 max-sm:text-sm">Download</li>
                    <motion.img
                      src="/FileArrowDown.png"
                      width={32}
                      height={32}
            ...
            <div className="xl:hidden xl:w-[403]">
              <div>
                <div className=" w-full items-center justify-center bg-[#000000] px-4 py-4 text-black">
                  <ul className="list-inside text-[#FFFFFFCC] opacity-80 max-sm:text-sm">
      ...
      <section id="other-products" className="paddings  w-full bg-[#282828] max-sm:px-3 ">
        <div className="w-full     xl:py-10">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="custom-text first-word-color flex text-center text-5xl font-bold text-[#FFFFFFcc] max-xl:text-2xl xl:my-6 xl:w-[924px] ">
